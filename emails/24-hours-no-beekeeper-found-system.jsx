...
export const subject = "A Colony Went Unclaimed";

export default function 24HoursNoBeekeeperFoundSystem({
      ...
      <Section>
        ...
        <Column style={{ width: '50%', verticalAlign: 'top' }}>
          <Text
            ...
            dangerouslySetInnerHTML={{ __html: `A Report Went Unclaimed in ${swarmcity}` }}
          />
          <Text
          ...
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
            dangerouslySetInnerHTML={{ __html: `Reporter: ${reportemail}` }}
          />
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
