...
export const subject = "Bee colony reported in Springfield - Claim now";

export default function SwarmReportedBeekeeper({
    ...
    <Html>
      ...
      <Section>
        ...
        <Column style={{ width: '50%', verticalAlign: 'top' }}>
          ...
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
            dangerouslySetInnerHTML={{ __html: "For more details and to claim these bees:" }}
          />
      ...
      <Text
        style={{ fontSize: '20px', fontWeight: 600, lineHeight: '1.3', margin: '0 0 12px 0', color: '#333333' }}
        dangerouslySetInnerHTML={{ __html: "Switch to TextMsg or WhatsApp Alerts" }}
      />
      <Text
        style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
        dangerouslySetInnerHTML={{ __html: "If you'd prefer to get swarm alerts via text message (SMS) or WhatsApp, we ask that you become a contributor to support Swarmed." }}
      />
      <Section style={{ padding: '18px 0 0 0', margin: 0 }} />
      <Section>
        <Column style={{ width: '50%', verticalAlign: 'top' }}>
          <Text
            style={{ fontSize: '20px', fontWeight: 600, lineHeight: '1.3', margin: '0 0 12px 0', color: '#333333' }}
            dangerouslySetInnerHTML={{ __html: `This swarm was reported via ${swarmassociation}` }}
          />
        </Column>
        <Column style={{ width: '50%', verticalAlign: 'top' }}>
      ...
      <Text
        style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
        dangerouslySetInnerHTML={{ __html: "When you claim a report, be sure to message the person promptly to make a plan to pick up the colony so that they know they are in good hands." }}
      />
      <Img
