import { Html, Head, Body, Container, Img, Link, Text, Section, Column, Hr, Row } from '@react-email/components';

export const subject = "A colony was just reported near you in Springfield";

export default function SwarmReportedBeekeeperNoTextmsg({
    ...
    <Html>
      ...
      <Section>
        ...
        <Column style={{ width: '50%', verticalAlign: 'top' }}>
          <Text
            ...
            dangerouslySetInnerHTML={{ __html: `A colony has been reported in ${swarmcity}` }}
          />
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
          ...
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
            dangerouslySetInnerHTML={{ __html: "For more details or to claim this report:" }}
          />
      ...
      <Section>
        <Column style={{ width: '50%', verticalAlign: 'top' }}>
          ...
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
            dangerouslySetInnerHTML={{ __html: "By claiming a swarm or established hive, you take responsibility for ensuring a safe and successful removal. " }}
          />
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
      ...
      <Text
        style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
        dangerouslySetInnerHTML={{ __html: "When you claim a report, be sure to message the person promptly to make a plan to pick up the bees so that they know they are in good hands." }}
      />
      <Img
