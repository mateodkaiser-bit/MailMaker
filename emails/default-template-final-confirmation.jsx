...
export default function DefaultTemplateFinalConfirmation() {
  return (
    <Html>
      <Head />
      ...
      <Text
        ...
        dangerouslySetInnerHTML={{ __html: "<span style=\"color:#676a6c\">You are now added to our mailing list.</span>" }}
      />
      <Section style={{ padding: '30px 0 0 0', margin: 0 }} />
