...
export const subject = "You have been unsubscribed successfully";

export default function DefaultTemplateUnsubscriptionFollowUp() {
  return (
    <Html>
      <Head />
      ...
      <Text
        ...
        dangerouslySetInnerHTML={{ __html: "We are sorry to see you go" }}
      />
      <Section style={{ padding: '30px 0 0 0', margin: 0 }} />
      <Text
        style={{ textAlign: 'center', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
        dangerouslySetInnerHTML={{ __html: "<span style=\"color:#676a6c\">Your un-subscription has been confirmed</span>" }}
      />
      <Section style={{ padding: '30px 0 0 0', margin: 0 }} />
