...
export const subject = "No Beekeeper Found";

export default function NoBeekeeperFoundSystem({
  ...
  reportemail = "https://swarmwatch.example.org/report/456",
      ...
      <Section>
        ...
        <Column style={{ width: '50%', verticalAlign: 'top' }}>
          <Text
            ...
            dangerouslySetInnerHTML={{ __html: `No Beekeeper Was Found in ${swarmcity}` }}
          />
          <Text
          ...
          <Text
            style={{ textAlign: 'left', color: '#676a6c', fontSize: '16px', lineHeight: '1.6', margin: '0 0 8px 0' }}
            dangerouslySetInnerHTML={{ __html: `Swarm Reporter: ${reportemail}` }}
          />
        </Column>
      </Section>
      <Section>
